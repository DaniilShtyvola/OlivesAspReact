...
const PublishNews: FC<PublishNewsProps> = () => {
   ...
   const handleClickSubmit = async (e) => {
      ...
      try {
         ...
         await axios.post(`${apiUrl}/api/news/add`, {
            headers: {
               "X-Key": `${token}`
            },
            "Title": title,
            ...
            "Icon": image,
            "Publisher": "VivoOlio",
            "PublisherIcon": "https://yt3.googleusercontent.com/ljJ3dvykCsQgztfwX4q1Ch6bLuBSWk5j767HFs-3Ehrcd26ezH5aYS02whwRMDRAZBJp0GstiA=s900-c-k-c0x00ffffff-no-rj",
